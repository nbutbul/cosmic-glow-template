...
const services = [
  {
    icon: Video,
    title: "Be Social",
    description: "תוכן שעוצר נשימה? זה בדיוק מה שאנחנו עושים. צילום תמונות וסרטונים שמושכים את העין, מדברים בשפה של הקהל, וממירים צפיות בלייקים, שיתופים ומכירות",
  ...
  },
  {
    icon: Instagram,
    title: "ניהול רשתות",
    description: "כל פוסט, כל סטורי, כל מילה – מעצבים את התדמית שלכם. בלי אסטרטגיה שיווקית, אתם פשוט מקווים שזה יעבוד. תנו לנו להוביל – התוצאות ידברו בעד עצמן.",
...
const ServicesSection = () => {
  ...
  return (
    <section id="services" ref={ref} className="min-h-screen py-32 px-4 md:px-8 relative flex flex-col justify-center">
