    ...
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4">
      ...
      <div className="text-center z-10 max-w-5xl">
        <motion.p
          ...
          dir="rtl"
        >
          סטודיו <span className="bg-primary text-primary-foreground normal-case font-bold px-3 py-1 rounded-full glow-pulse inline-block">Art33</span> - מומחים לצילום וסושיאל
        </motion.p>
