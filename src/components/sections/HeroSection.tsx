    ...
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4">
      ...
      <div className="text-center z-10 max-w-5xl">
        <motion.p
          ...
          dir="rtl"
        >
          סטודיו <span className="text-primary normal-case font-bold text-xl md:text-2xl drop-shadow-[0_0_10px_hsl(var(--primary)/0.5)]">Art33</span>, מומחים לצילום וסושיאל
        </motion.p>
